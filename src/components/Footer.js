...
const Footer = () => {
    return (
        <div className="w-full h-auto bg-gray-200 rounded-xl p-8 mb-4">
            <div className="flex flex-col md:flex-row justify-between">
                ...
                <div className="mb-6 md:mb-0">
                    ...
                    <p className="text-black mb-4">One step Solutions for your requirements</p>
                    <ul className="text-black space-y-1 mb-8">
                        <li>Email: contact@cirista.in</li>
                        <li>Phone: +91 88888 88888</li>
                        <li>Address: Dharwad, India</li>
                    </ul>
                </div>

                {/* Middle Section */}
                <div className="flex flex-col md:flex-row space-x-0 md:space-x-16 md:space-y-0 space-y-4">
                    <div>
                    ...
                    <div>
                        <h3 className="text-black font-medium mb-4">Internships</h3>
                        <ul className="space-y-2">
                    ...
                    <div>
                        <h3 className="text-black font-medium mb-4">Resources</h3>
                        <ul className="space-y-2">
